...
int get_branch_offset(Instruction instruction) {
  ...
  offset |= ((instruction.sbtype.imm5 & 0x00000001) << 11);
  offset |= (instruction.sbtype.imm5 & 0x0000001e);
  offset |= ((instruction.sbtype.imm7 & 0x0000003f) << 5);
  offset |= ((instruction.sbtype.imm7 & 0x00000040) << 6);
...
int get_jump_offset(Instruction instruction) {
  /* YOUR CODE HERE */
  int offset = 0x00000000;
  offset |= ((instruction.ujtype.imm & 0x000000ff) << 12);
  offset |= ((instruction.ujtype.imm & 0x00000100) << 3);
  offset |= ((instruction.ujtype.imm & 0x0007fe00) >> 8);
  offset |= ((instruction.ujtype.imm & 0x00080000) << 1);
